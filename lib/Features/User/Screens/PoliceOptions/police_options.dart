...
import 'package:public_emergency_app/Features/User/Screens/map_screen.dart';
          ...
          children: [
              ...
              child: ListTile(
                ...
                onTap: () async {
                  if (await Permission.phone.request().isGranted) {
                    final url = Uri.parse("tel:15");
                    await launchUrl(url);
                  } else {
                    Get.snackbar(
                        "Permission Denied", "Phone call permission is required.");
                  }
                },
              ),
            ),
            ...
            Card(
              child: ListTile(
                ...
                onTap: () {
                  smsController
                      .shareLocationViaEmail("Police Emergency – Police Help Needed");
                },
              ),
            ),
          ],
